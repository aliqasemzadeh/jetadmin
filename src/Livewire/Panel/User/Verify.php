...
class Verify extends Component
{
    ...
    public function verify_request()
    {
        if(!$this->verify->id_card_file) {
            $this->alert('warning', __('jetadmin::jetadmin.please_upload_id_card_file'));
        } else if(!$this->verify->verify_file) {
            $this->alert('warning', __('jetadmin::jetadmin.please_upload_verify_file'));
        } else {
            $this->validate([
            ...
            $this->alert('success', __('jetadmin::jetadmin.request_sent'));
        }

        $this->alert('warning', __('jetadmin::jetadmin.please_check_data'));
    }
