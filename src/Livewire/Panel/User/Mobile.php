...
class Mobile extends Component
{
    ...
    public function send()
    {
        ...
        SendMobileTextMessageJob::dispatch(__('jetadmin::jetadmin.verify_code_is', [$userVerifyCode->code]), $this->mobile);
    ...
    public function verify()
    {
        ...
        $this->alert('success', __('jetadmin::jetadmin.mobile_verified_successfully'));
