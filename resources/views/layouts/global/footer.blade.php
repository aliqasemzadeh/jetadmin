        ...
        <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item"><a href="{{ route('faqs.index') }}" class="link-secondary">{{ __('jetadmin::jetadmin.faqs') }}</a></li>
                    <li class="list-inline-item"><a href="{{ route('article.index') }}" class="link-secondary">{{ __('jetadmin::jetadmin.articles') }}</a></li>
                </ul>
            </div>
