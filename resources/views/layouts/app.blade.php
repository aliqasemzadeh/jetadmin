...
<div id="drawer-right-example"
     class="fixed top-0 right-0 border-l border-gray-200 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-gray-50 w-80 dark:bg-gray-900"
                ...
                @can('admin_user_management')
                    <li>
                        ...
                        <ul id="dropdown-example" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ route('admin.user.index') }}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">{{ __('Users') }}</a>
                            </li>
                            <li>
                                <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ __('Team') }}</a>
                            </li>
                            <li>
...
<div id="drawer-example"
     class="fixed top-0 left-0 border-r border-gray-200 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-gray-50 w-80 dark:bg-gray-900"
...
<main>
    <div class="container max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="mt-16">
            <!-- Page Heading -->
            @if (isset($header))
                <header class="bg-gray-900 dark:bg-gray-400 shadow">
