...
<flux:navlist variant="outline">
    ...
    <flux:navlist.group heading="{{ __('jetadmin.panels.user') }}" class="grid">
        @can('user_dashboard')<flux:navlist.item icon="home" :href="route('user.dashboard.index')" :current="request()->routeIs('user.dashboard.index') || request()->routeIs('dashboard')" wire:navigate>{{ __('Dashboard') }}</flux:navlist.item>@endcan
