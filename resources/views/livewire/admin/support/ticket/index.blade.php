<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.support.ticket.index') }}">{{ __('jetadmin::bap.tickets') }}</a></li>
        </ol>
    </x-slot>
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('updated_at')">{{ __('jetadmin::bap.updated_at') }}
