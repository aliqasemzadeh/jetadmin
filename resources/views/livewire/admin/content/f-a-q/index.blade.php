<div>
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button onclick="Livewire.emit('showModal', 'admin.content.f-a-q.create')" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        {{ __('jetadmin::jetadmin.create_faq') }}
                    </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.content.faq.index') }}">{{ __('jetadmin::jetadmin.faqs') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::jetadmin.faqs') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('question')">{{ __('jetadmin::jetadmin.question') }}
                    ...
                    <th wire:click="sortByColumn('answer')">{{ __('jetadmin::jetadmin.answer') }}
