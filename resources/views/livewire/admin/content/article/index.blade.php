<div>
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button onclick="Livewire.emit('showModal', 'admin.content.article.create')" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        {{ __('jetadmin::bap.create_article') }}
                    </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.content.article.index') }}">{{ __('jetadmin::bap.articles') }}</a></li>
        </ol>
    </x-slot>
