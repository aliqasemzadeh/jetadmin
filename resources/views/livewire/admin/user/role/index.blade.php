<div>
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <button onclick="Livewire.emit('showModal', 'admin.user.role.create')" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    {{ __('jetadmin::jetadmin.create_role') }}
                </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.user.role.index') }}">{{ __('jetadmin::jetadmin.roles_word') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::jetadmin.roles_word') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="card-footer d-flex justify-content-between">
            <div>
                <div class="btn-group btn-group-sm w-100">
                    <button type="button" wire:click="deleteSelected" class="btn">{{ __('jetadmin::jetadmin.delete') }} ({{ count($selectedRoles) }})</button>
                </div>
