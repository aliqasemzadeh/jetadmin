<div>
    <x-slot name="title">
        {{ __('jetadmin::jetadmin.permissions_word') }}
    </x-slot>
    <x-slot name="actions">
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <button onclick="Livewire.emit('showModal', 'admin.user.permission.create')" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    {{ __('jetadmin::jetadmin.create_permission') }}
                </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.user.permission.index') }}">{{ __('jetadmin::jetadmin.permissions_word') }}</a></li>
        </ol>
    </x-slot>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::jetadmin.permissions_word') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
            ...
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                @foreach($permissions as $permission)
                    <tr>
                        ...
                        <td>{{ __('jetadmin::permissions.'.$permission->name) }}</td>
                        <td class="text-end">
