   ...
   <x-slot name="title">
        ...
        <div class="col-auto ms-auto d-print-none">
            <div class="btn-list">
                <button onclick="Livewire.emit('showModal', 'admin.user.create')" class="btn btn-primary d-none d-sm-inline-block">
                    ...
                    {{ __('jetadmin::jetadmin.create_user') }}
                </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.user.index') }}">{{ __('jetadmin::jetadmin.users') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::jetadmin.users') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('email')">{{ __('jetadmin::jetadmin.email') }}
        ...
        <div class="card-footer d-flex justify-content-between">
            <div>
                <div class="btn-group btn-group-sm w-100">
                    <button type="button" wire:click="deleteSelected" class="btn">{{ __('jetadmin::jetadmin.delete') }} ({{ count($selectedUsers) }})</button>
                    <button type="button" wire:click="exportSelectedQuery" class="btn">{{ __('jetadmin::jetadmin.export') }} ({{ count($selectedUsers) }})</button>
                </div>
