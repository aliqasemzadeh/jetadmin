<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.user.team.index') }}">{{ __('jetadmin::bap.teams_word') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::bap.teams_word') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
