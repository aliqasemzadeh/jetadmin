    ...
    <form wire:submit.prevent="create">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('jetadmin::jetadmin.create_team') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label" for="search">{{ __('jetadmin::jetadmin.user') }}</label>
                    <input type="text" wire:model="search" class="form-control @error('search') is-invalid @enderror" name="search" placeholder="{{ __('jetadmin::jetadmin.user') }}">
                    @error('user_id')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <ul class="list-group">
                ...
                <div class="mb-3">
                    <label class="form-label" for="personal">{{ __('jetadmin::jetadmin.personal') }}</label>
                    <select  wire:model="personal" class="form-control @error('personal') is-invalid @enderror" name="personal" placeholder="{{ __('jetadmin::jetadmin.personal') }}">
                        <option></option>
                        <option value="0">{{ __('jetadmin::jetadmin.public_team') }}</option>
                        <option value="1">{{ __('jetadmin::jetadmin.personal_team') }}</option>
                    </select>
                    @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
