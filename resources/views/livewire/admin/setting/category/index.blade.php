<div>
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <button onclick="Livewire.emit('showModal', 'admin.setting.category.create')" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        {{ __('jetadmin::jetadmin.create_category') }}
                    </button>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.setting.category.index') }}">{{ __('jetadmin::jetadmin.categories') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::jetadmin.categories') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('type')">{{ __('jetadmin::jetadmin.type') }}
                    ...
                    <th wire:click="sortByColumn('language')">{{ __('jetadmin::jetadmin.language') }}
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>{{ __('jetadmin::jetadmin.category_types.'.$category->type) }}</td>
