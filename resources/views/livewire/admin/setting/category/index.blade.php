<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.setting.category.index') }}">{{ __('jetadmin.categories') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin.categories') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('type')">{{ __('jetadmin.type') }}
                    ...
                    <th wire:click="sortByColumn('language')">{{ __('jetadmin.language') }}
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>{{ __('jetadmin.category_types.'.$category->type) }}</td>
