    ...
    <form wire:submit.prevent="create">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('jetadmin::jetadmin.create_category') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label" for="type">{{ __('jetadmin::jetadmin.type') }}</label>
                    <select wire:model="type" class="form-control @error('type') is-invalid @enderror" name="type">
                        <option></option>
                        @foreach(__('jetadmin::jetadmin.category_types') as $key => $value)
