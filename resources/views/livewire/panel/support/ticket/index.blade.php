<div>
    ...
    <x-slot name="breadcrumb">
        <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
            <li class="breadcrumb-item"><a href="{{ route('panel.dashboard.index') }}">{{ __('jetadmin::bap.dashboard') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('panel.support.ticket.index') }}">{{ __('jetadmin::bap.tickets') }}</a></li>
        </ol>
    </x-slot>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">{{ __('jetadmin::bap.tickets') }}</h3>
        </div>
        <div class="card-body">
            <div class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tr>
                    ...
                    <th wire:click="sortByColumn('category_id')">{{ __('jetadmin::bap.category') }}
                ...
                @foreach($tickets as $ticket)
                    <tr>
                        ...
                        <td class="text-end">
                                <a href="{{ route('panel.support.ticket.view', [$ticket->id]) }}" class="btn btn-primary btn-icon btn-sm">
        ...
        <div class="card-footer d-flex justify-content-between">
            <div>
                <div class="btn-group btn-group-sm w-100">
                    <button type="button" wire:click="archiveSelected" class="btn">{{ __('jetadmin::bap.archive') }} ({{ count($selectedItems) }})</button>
                </div>
