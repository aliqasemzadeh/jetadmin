<div class="col-md-6 col-xl-6">
        <form wire:submit.prevent="upload" class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('jetadmin.id_card') }}</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="mb-2">
                        <div class="form-label">{{ __('jetadmin.id_card_file') }}</div>
                    ...
                    <div class="input-group mb-1">
                        ...
                        <input type="text" value="{{ __('jetadmin.id_should_be_visible') }}" class="form-control" placeholder="subdomain" autocomplete="off">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary">{{ __('jetadmin.upload') }}<button>
            </div>
        </form>
    </div>
